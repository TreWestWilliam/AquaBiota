...
public class Vector2IntRefDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        {
            Vector2Int varVal = (variable.objectReferenceValue as Vector2IntVariable).Value;
            GUI.enabled = false;
            Vector2Int newValue = EditorGUI.Vector2IntField(position, "", varVal);
            GUI.enabled = true;
        }
