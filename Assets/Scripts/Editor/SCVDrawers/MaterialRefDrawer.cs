...
public class MaterialRefDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        Material value = useConstant.boolValue ? (constantValue.objectReferenceValue as Material) : (variable.objectReferenceValue ? (variable.objectReferenceValue as MaterialVariable).Value : null);
        ...
        {
            GUI.enabled = false;
            EditorGUI.ObjectField(position, "", value, typeof(Material), false);
            GUI.enabled = true;
        }
