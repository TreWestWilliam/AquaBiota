...
public class Vector3IntRefDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        {
            Vector3Int varVal = (variable.objectReferenceValue as Vector3IntVariable).Value;
            GUI.enabled = false;
            Vector3Int newValue = EditorGUI.Vector3IntField(position, "", varVal);
            GUI.enabled = true;
        }
